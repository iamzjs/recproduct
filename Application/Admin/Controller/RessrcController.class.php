...
// +----------------------------------------------------------------------
	...
	class RessrcController extends BaseController {
	   public function _initialize(){
		...
		public function getCourse(){
			$id = I("get.technoid");
			$sql = "select c.* from course c left join techno t1 on c.technoid=t1.id left join techno t2 on t1.parentid = t2.id left join techno t3 on t2.parentid = t3.id where c.technoid='".$id."' or t1.parentid='".$id."' or t2.parentid='".$id."'";
