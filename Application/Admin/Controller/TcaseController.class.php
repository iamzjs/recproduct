...
// +----------------------------------------------------------------------
	...
	class TcaseController extends BaseController {
	   public function _initialize(){
		...
		public function index(){
			M("")->query("update tcase t left join techno t1 on t.technoid=t1.id set t.technoname=t1.name");M("")->query("update tcase t left join course t1 on t.kcdm=t1.kcdm set t.kcmc=t1.kcmc");M("")->query("update tcase t left join section t1 on t.sectionid=t1.id set t.sectionname=t1.name");
			//推荐位
