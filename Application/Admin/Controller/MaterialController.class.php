	...
	class MaterialController extends BaseController {
	   public function _initialize(){
		...
		public function index(){
			M("")->query("update material t left join ressrc t1 on t.ressrcid=t1.id set t.ressrcname=t1.name");M("")->query("update material t left join sctype t1 on t.sctypeid=t1.id set t.sctypename=t1.name");M("")->query("update material t left join techno t1 on t.technoid=t1.id set t.technoname=t1.name");M("")->query("update material t left join course t1 on t.kcdm=t1.kcdm set t.kcmc=t1.kcmc");
			//推荐位
		...
		public function form(){
			$this->assign("ressrclist",M("ressrc")->select());$this->assign("sctypelist",M("sctype")->select());
